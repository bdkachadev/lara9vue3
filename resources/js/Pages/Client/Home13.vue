  ...
  <AuthenticatedLayout>
    <div class="bg-white">
            ...
            >
              ...
              >
                <div class="flex items-center justify-between px-4">
                  ...
                  >
                    <span class="sr-only1">Close menu</span>
                      ...
                      <div class="space-y-6">
                        ...
                        >
                          <input
                            ...
                            @click="filterBy('category', option, null)"
      ...
      <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 class="text-xl font-bold tracking-tight text-gray-900"></h1>
          <div class="flex items-center">
              ...
              >
                ...
                >
                  <div class="py-1">
                    ...
                    >
                      <a
                        @click="filterBy(null, {}, option.sortBy)"
                        :class="[
            ...
            <!-- <button
              ...
              >
                <span class="sr-only1">View grid</span>
            ...
            >
              <span class="sr-only1">Filters</span>
        ...
        <section aria-labelledby="products-heading" class="pt-6 pb-24">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            <!-- Filters -->
            <form
              class="hidden lg:block border-r border-b border-l border-gray-400 lg:border-t lg:border-gray-300 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
            >
                  ...
                  <div class="space-y-4">
                    ...
                    >
                      ...
                      <!-- <option
                        ...
                        v-for="subcategory in option.sub_categories"
...
const sortOptions = [
  ...
  { sortBy: "lTohPrice", name: "Price: Low to High", href: "#", current: false },
  { sortBy: "hTolPrice", name: "Price: High to Low", href: "#", current: false },
];
const subCategories = [
  { name: "Totes", href: "#" },
  { name: "Backpacks", href: "#" },
...
const filters = [
  ...
  //   },
  {
    id: "category",
    name: "Category",
    options: props.categoriesAll,
  },
  {
    id: "brand",
    name: "Brand",
    options: props.brandsAll,
  },
  //   {
  //     id: "size",
  //     name: "Size",
...
const filterBy = computed(() => {
  ...
  return function (filter_type = null, payload = {}, sortBy = null) {
    ...
    if (sortBy == "lTohPrice") {
      //   alert("lTohprice2222");
      props.products = props.products.sort((a, b) => {
        return a.price - b.price; //a[sortBy].toString().localeCompare(b[sortBy].toString());
      });
    }
    if (sortBy == "hTolPrice") {
      //   alert("hTolprice");z`
    ...
    //     (prev, curr) => Date.parse(prev.created_at) - Date.parse(curr.created_at)
    //   );
    // }
  };
});
